...
import type { Apprenant } from '@/hooks/useRH'
    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Recruter comme employé" size="md">
      <div className="space-y-4">
        ...
        <div>
          ...
          <input value={poste} onChange={(e) => setPoste(e.target.value)} placeholder="ex. Technicien soudeur"
        ...
        <div className="flex gap-2 justify-end pt-2">
          ...
          <Button onClick={() => recruter.mutate({ id: apprenant.id, poste, salaire_brut_xaf: Number(salaire) }, { onSuccess: onClose })}
            disabled={!poste || !salaire || recruter.isPending}>
